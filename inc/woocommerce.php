...
add_action('woocommerce_before_single_product', 'storezz_add_bootstrap_single_product_opening', 4);

function storezz_add_bootstrap_single_product_opening() {
  echo '<div class="container"><div class="row"><div class="col-12">';
}

/* -------------------- Adding closing Bootstrap divs ---------------------------------------------------------- */
